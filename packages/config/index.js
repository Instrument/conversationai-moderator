...
const config = convict({
  ...
  google_score_auth: {
    ...
    format: String,
    default: 'TWFrZSBjb21tZW50cyBncmVhdCBhZ2FpbiE',
  ...
  google_client_id: {
    ...
    format: String,
    default: '371591676347-e8va7i3lq4u8ulgjjnpgstcjaluf55v7.apps.googleusercontent.com',
  ...
  google_client_secret: {
    ...
    format: String,
    default: 'ze06spF32i4B6gBoNsJfz3iS',
